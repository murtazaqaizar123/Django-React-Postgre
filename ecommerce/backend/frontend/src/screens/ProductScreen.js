...
const ProductScreen = () => {
    ...
    // console.log('errorProductReview:', errorProductReview)
                        ...
                        <Col md={6}>
                            ...
                            <ListGroup variant="flush">
                                ...
                                <ListGroup.Item>
                                    ...
                                    {errorProductReview && <Message variant='danger'>{errorProductReview.data?.detail}</Message>}
                                    {userInfo ? (
